...
if 'dlcs302-2' == _hostname:
    base_path = '/home/bb79e2/deepfashion-fyp-eric-ug/Deep-Fashion-Analysis-ECCV2018/dataset/'
else:
    base_path = '/home/bb79e2/deepfashion-fyp-eric-ug/Deep-Fashion-Analysis-ECCV2018/dataset/'
...
#left, right chest, left, right shoulder, left,right waist, arm start,end
lm2name = ['L.Che', 'R.Che', 'L.Sho', 'R.Sho', 'L.Wai', 'R.Wai', 'Arm.S', 'Arm.E']
